...
按提示选择服务商、输入 API Key、选择模型即可。

详细教程见：[OpenClaw 国内 API 配置指南](./OPENCLAW-CN-API-GUIDE.md)

## 文档

- [OpenClaw 国内 API 配置指南](./OPENCLAW-CN-API-GUIDE.md) - 推荐使用配置向导
